...
//Задание 5
const getUserWithEmail = (users, email) => users.find(users => users.email);
...
const getSortedUniqueSkills = users => 
  users.map(user=>user.skills).reduce((allSkills, user) => [...allSkills, ...user], []).filter((elem, index, array) => array.indexOf(elem) === index)
